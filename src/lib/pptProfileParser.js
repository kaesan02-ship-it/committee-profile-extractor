...
const DEGREE_PATTERN_GLOBAL = /(?:박사과정수료|박사수료|석박사\s*통합|석박사통합|박사|석사|학사|전문학사|\bPh\.?\s*D\b|\bDoctor\b|\bMBA\b|\bM\.?\s*A\b|\bM\.?\s*S\b|\bB\.?\s*A\b|\bB\.?\s*S\b)/i;
const DEGREE_ONLY_PATTERN = /^(?:박사과정수료|박사수료|석박사\s*통합|석박사통합|박사|석사|학사|전문학사|\bPh\.?\s*D\b|\bDoctor\b|\bMBA\b|\bM\.?\s*A\b|\bM\.?\s*S\b|\bB\.?\s*A\b|\bB\.?\s*S\b)$/i;
